...
export default function Profile (){
    ...
    return(
        <section className="relative">
            ...
            <button className=" absolute -top-6.25 -right-2 flex justify-center items-center bg-[#FFFFFF] w-10 h-10 rounded-xl">
            ...
            <div className="max-w-[356.7px]">
                <p className="font-extrabold font-plusJakartaSans text-[36px] leading-10 tracking-[-0.9px] text-[#1C1B1B] text-center">Chanor James</p>
                <p className="font-medium font-montserrat text-[16px] leading-[29.25px] text-[#3C4A46] text-center">Product Designer</p>
                <p className="max-w-[267.06px] m-auto font-manrope text-[18px] leading-[29.25px] text-[#3C4A46] text-center">I design intuitive interface to increase user retention by 45%  </p>
            </div>

            <div className=" w-full max-w-74 m-auto flex justify-between gap-4">
                {socialMedia && socialMedia.map((media, index) => (
                  <a href={media.link} key={index} className="w-14 h-14 rounded-2xl bg-[#FFFFFF] flex justify-center items-center my-6">
